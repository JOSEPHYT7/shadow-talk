...
function OrbitAvatar({ src, alt, color, size = 72 }: OrbitAvatarItem) {
  return (
    <div
      className="orbit-avatar-wrapper rounded-full border border-black/[0.07] bg-white p-[3px] shadow-[0_2px_8px_rgba(0,0,0,0.06)] dark:border-white/10 dark:bg-[#161616]"
...
function OrbitPill({ icon, label }: OrbitPillItem) {
  return (
    <div className="orbit-pill-wrapper flex min-h-[27px] items-center gap-2 whitespace-nowrap rounded-full border border-black/[0.08] bg-white py-[5px] px-2.5 text-[12.5px] font-medium text-[#6c6c78] shadow-[0_2px_6px_rgba(0,0,0,0.05)] dark:border-white/10 dark:bg-[#161616] dark:text-white/60">
...
function OrbitCard({ emoji, badge }: OrbitCardItem) {
  return (
    <div className="orbit-card-wrapper relative flex h-[52px] w-[52px] items-center justify-center rounded-xl border border-black/[0.08] bg-[#f7f7f8] text-[22px] leading-none shadow-[0_2px_8px_rgba(0,0,0,0.05)] dark:border-white/10 dark:bg-[#1c1c1c]">
...
function OrbitStatus({ label }: OrbitStatusItem) {
  return (
    <div className="orbit-status-wrapper flex h-[30px] items-center gap-1.5 whitespace-nowrap rounded-full border border-[#a3d5b3] bg-[#cbe8d3] px-2.5 text-[13.5px] font-medium text-[#2f5b3a] shadow-[0_2px_6px_rgba(0,0,0,0.05)] dark:border-[#2f5b3a] dark:bg-[#17301f] dark:text-[#a8e0b8]">
...
function OrbitCheck() {
  return (
    <div className="orbit-check-wrapper flex h-[50px] w-[50px] items-center justify-center rounded-full border border-[#a9d8b8] bg-[#c3e5cd] shadow-[0_2px_8px_rgba(0,0,0,0.06)] dark:border-[#2f5b3a] dark:bg-[#1c3a26]">
